...
const ReviewEntitySchema = Schema(
  name: r'ReviewEntity',
  id: -4715273279285640652,
  properties: {
  ...
  estimateSize: _reviewEntityEstimateSize,
  serialize: _reviewEntitySerialize,
  deserialize: _reviewEntityDeserialize,
  deserializeProp: _reviewEntityDeserializeProp,
);

int _reviewEntityEstimateSize(
  ReviewEntity object,
  List<int> offsets,
  ...
  bytesCount += 3 + object.authorUsername.length * 3;
  bytesCount += 3 + object.avatarUrl.length * 3;
  bytesCount += 3 + object.content.length * 3;
  return bytesCount;
}

void _reviewEntitySerialize(
  ReviewEntity object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
  ...
  writer.writeString(offsets[1], object.authorUsername);
...
ReviewEntity _reviewEntityDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = ReviewEntity(
    authorName: reader.readStringOrNull(offsets[0]) ?? "",
    authorUsername: reader.readStringOrNull(offsets[1]) ?? "",
...
P _reviewEntityDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension ReviewEntityQueryFilter
    on QueryBuilder<ReviewEntity, ReviewEntity, QFilterCondition> {
  QueryBuilder<ReviewEntity, ReviewEntity, QAfterFilterCondition>
      authorNameEqualTo(
    String value, {
  ...
  QueryBuilder<ReviewEntity, ReviewEntity, QAfterFilterCondition> ratingEqualTo(
    double? value, {
  ...
  QueryBuilder<ReviewEntity, ReviewEntity, QAfterFilterCondition> ratingBetween(
    double? lower,
    double? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ReviewEntityQueryObject
    on QueryBuilder<ReviewEntity, ReviewEntity, QFilterCondition> {}
